...
export default function CartPaymentPageImproved() {
  ...
  // ATOMIC CHECKOUT: Creates orders + payments in single transaction
  ...
  const isProcessing = checkoutMutation.isPending || billingLoading;
          ...
          <div className="p-4 bg-white/5 rounded-lg border border-white/5">
            ...
            <p className="text-xs text-gray-300 leading-relaxed">
              {billingLoading
                ...
                : "No address found. Add one to proceed."}
            </p>
          </div>
        </div>
      </div>
