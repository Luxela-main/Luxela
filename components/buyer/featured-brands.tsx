...
const BRANDS: Brand[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop", //replace with actual brand image cdn if possible
    href: "#",
  },
  {
    id: "2",
            ...
            {BRANDS.map((brand, i) => (
              ...
              >
                ...
                <div className="flex-1 py-8 flex flex-col justify-between">
                  <div>
                    <h3 className="text-white font-bold text-xl mb-3">{brand.name}</h3>
