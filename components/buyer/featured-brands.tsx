...
const BRANDS: Brand[] = [
  {
    ...
    name: "BAZ",
    description:
      "We are not singular. Our genetics are only a foundation, not a full identity. We grow, learn, forget, give, and take—changing every day. Our individuality is ever-evolving.",
    image:
      "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop", //replace with actual brand image cdn if possible
    href: "#",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    description:
      "Curating exceptional experiences through premium lifestyle products that speak to the modern connoisseur's refined taste and appreciation for quality.",
    image:
  ...
  },
  {
    ...
    name: "AURORA STUDIO",
    description:
      "Where creativity meets craftsmanship. Each piece tells a story of innovation, beauty, and the endless pursuit of artistic excellence.",
    image:
    ...
    <div className="mt-16">
      <main className="px-6">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-xl capitalize font-bold text-white flex items-center">
            <button
              onClick={() => router.back()}
