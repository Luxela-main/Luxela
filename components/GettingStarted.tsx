    ...
    <section id="brands" className="py-20 px-4">
      <main className="max-w-6xl mx-auto">
        <div className="text-center max-w-[1041px] mx-auto">
          ...
          <p
            className="text-[#BFBFBF] mt-5 mb-12 text-sm md:text-base "
            data-aos="fade-up">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-9">
          {gettingStarted.map((started, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center h-[538px] rounded-[12px] bg-[#1A1A1A]"
              ...
              <Image
                ...
                src={started.image}
                alt={"Luxela"}
                className="object-cover h-full rounded-tr-[12px] rounded-tl-[12px]"
              />
              <div className="mt-12 max-w-[392px] px-5">
                <h3 className="mb-3 text-lg text-[#F6F6F6] font-semibold">
                  {started.title}
                </h3>
                <p className="text-sm text-[#BFBFBF] mb-10">
                  {started.description}
                </p>
              </div>
            </div>
