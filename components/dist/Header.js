...
function Header() {
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("header", { className: "bg-[url('/images/hero-bg-1440x1066.png')] bg-cover bg-center bg-no-repeat h-screen 2xl:h-[1024px] mx-auto w-full relative" },
            react_1["default"].createElement("div", { className: "absolute top-0 left-0 2xl:left-1/2 transform -translate-x-1/2 bg-[url('/images/Glare-1321x760.png')] h-[760px] w-[200px] bg-center lg:w-[1321px] pointer-events-none" }),
            ...
            react_1["default"].createElement("div", { className: "relative flex flex-col pt-20 items-center justify-center" },
                ...
                react_1["default"].createElement("div", { className: 'text-center w-full max-w-[793px] px-8 lg:px-0 mt-6' },
                    react_1["default"].createElement("h1", { className: "text-white text-[1.5rem] lg:text-[3rem] font-bold leading-[120%] tracking-[6%] " },
                        "Authentic Fashion, ",
                        react_1["default"].createElement("span", { className: 'text-[#8451E1]' }, "Global Reach"),
                        react_1["default"].createElement("br", null),
                        " A New Era of E-commerce"),
                    react_1["default"].createElement("p", { className: 'text-sm md:text-base text-[#BFBFBF] my-5' }, "An e-commerce platform where you can buy and sell authentic fashion products easily. Pay with local currencies or digital assets, and experience seamless, affordable fashion like never before."),
                    react_1["default"].createElement("div", { className: 'grid grid-cols-2 gap-5 w-full h-12 max-w-[338px] mx-auto' },
                ...
                react_1["default"].createElement("div", { className: "hidden lg:flex z-10 mt-10 w-full max-w-[1611px] mx-auto h-full min-h-[700px] relative overflow-x-hidden" },
                ...
                react_1["default"].createElement("div", { className: "lg:hidden z-10 mt-10 w-full max-w-[1611px] mx-auto h-full min-h-[700px] relative overflow-x-hidden" },
                    react_1["default"].createElement("div", { className: 'rounded-[16px] border-[0.75px] border-[#8451E1] -left-[22px] absolute w-[78px] h-[170px]' },
                        react_1["default"].createElement(image_1["default"], { src: "/images/hero/1st.png", width: 300, height: 375, alt: "Image of cloth", className: "rounded-[16px] w-full h-full" })),
                    react_1["default"].createElement("div", { className: 'rounded-[16px] border-[0.75px] border-[#8451E1] absolute top-[72px] left-[74px] w-[78px] h-[170px]' },
                        react_1["default"].createElement(image_1["default"], { src: "/images/hero/2nd.jpg", width: 300, height: 375, alt: "Image of cloth", className: "rounded-[16px] w-full h-full" })),
                    react_1["default"].createElement("div", { className: 'rounded-[16px] border-[0.75px] border-[#8451E1] absolute top-[173px] left-[200px] w-[78px] h-[170px]' },
                        react_1["default"].createElement(image_1["default"], { src: "/images/hero/3rd.png", width: 300, height: 375, alt: "Image of cloth", className: "rounded-[16px] w-full h-full" })),
                    react_1["default"].createElement("div", { className: 'rounded-[16px] border-[0.75px] border-[#8451E1] absolute top-[72px] left-[320px] w-[78px] h-[170px]' },
                        react_1["default"].createElement(image_1["default"], { src: "/images/hero/4th.png", width: 300, height: 375, alt: "Image of cloth", className: "rounded-[16px] w-full h-full" })),
                    react_1["default"].createElement("div", { className: 'rounded-[16px] border-[0.75px] border-[#8451E1] -right-[30px] absolute w-[78px] h-[170px]' },
                        react_1["default"].createElement(image_1["default"], { src: "/images/hero/5th.png", width: 300, height: 375, alt: "Image of cloth", className: "rounded-[16px] w-full h-full" })))))));
}
