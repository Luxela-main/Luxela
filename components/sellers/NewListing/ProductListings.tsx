...
import { Search, Package, Filter, PlusCircle, SquarePen, Trash2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white px-2 lg:px-6 text-sm max-md:pt-6">
      ...
      {hasListings ? (
        <>
          ...
          {/* Listings Table */}
          <div className="bg-[#0d0d0d] rounded-lg overflow-scroll border border-[#1a1a1a]">
              ...
              <div className="p-16 text-center text-gray-500">
                ...
                <p className="text-sm">
                  {search
                    ...
                    : `You don't have any ${activeTab === "single" ? "single items" : "collections"} yet`}
                </p>
              </div>
            ) : (
              filteredListings.map((listing: any) => (
                <div key={listing.id} className="border-b border-[#1a1a1a] last:border-b-0">
                  <div className="grid grid-cols-6 gap-4 p-4 items-center text-sm hover:bg-[#151515] transition">
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white capitalize">{listing.title}</span>
                      </div>
                    </div>
                    <div className="text-gray-400">{listing.category || "N/A"}</div>
                    ...
                    <div className="flex items-center justify-start relative">
                      <button
                        onClick={() => setOpenActionMenu(openActionMenu === listing.id ? null : listing.id)}
                      ...
                      {openActionMenu === listing.id && (
                        <div className="absolute right-0 top-10 mt-1 w-40 bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg shadow-xl z-10">
                          <button
