    ...
    <section className='py-8'>
      ...
      {searchQuery && !hasResults ? (
        <div className="text-center py-20">
          <div className="max-w-md mx-auto border-2 border-[#E5E7EB] rounded-lg p-8 bg-[#8451E1]/5">
            <SearchX strokeWidth={1} className="w-16 h-16 mx-auto text-[#6B7280] mb-4" />
            <h3 className="text-white text-xl font-semibold mb-2">
              No results found
            </h3>
            <p className="text-[#D1D5DB] mb-1 font-medium">
