    ...
    if (ordersData?.data) {
      ...
      if (foundOrder) {
        const mappedOrder: Order = {
          ...
          recipientEmail: foundOrder.recipientEmail || '',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <Breadcrumb
          items={[
            ...
            { label: 'Processing', href: '/buyer/dashboard/orders/processing' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Status Section */}
            <div className="bg-yellow-500/10 border border-[#333] rounded-lg p-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-lg text-yellow-400">Processing</span>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              <p className="text-yellow-400 text-sm font-semibold mb-2">Processing</p>
              <p className="text-gray-300 text-xs">
                Your order is being prepared. A tracking number will be provided once your package ships.
              </p>
            </div>
          </div>
        </div>
