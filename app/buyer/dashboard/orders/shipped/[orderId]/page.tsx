...
export default function ShippedOrderDetailPage() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <Breadcrumb
          items={[
            ...
            { label: 'Shipped', href: '/buyer/dashboard/orders/shipped' },
            ...
            <div className="bg-blue-500/10 border border-[#333] rounded-lg p-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-lg text-blue-400">In Transit</span>
                </div>
              </div>

              <p className="text-gray-300">
                Your package is on its way! Expected delivery: {order.estimatedArrival ? order.estimatedArrival.toLocaleDateString() : 'Soon'}
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-gray-300 text-xs">
                Your package is on its way. Once you receive it, please confirm delivery.
              </p>
            </div>
          </div>
        </div>
