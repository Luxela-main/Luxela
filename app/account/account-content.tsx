  ...
  return (
    <div className="min-h-screen bg-black text-white py-12 px-6 md:px-20">
      <div className="max-w-3xl mx-auto bg-zinc-900 rounded-xl shadow-md p-8">
        {/* Header */}
        <div className="flex items-center space-x-4 mb-8 pb-6 border-b-2 border-[#D1D5DB]">
          <div>
            <ArrowLeft
              className="h-8 w-8 cursor-pointer hover:text-[#6B7280] transition"
              onClick={router.back}
            />
          </div>
          <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-[#E5E7EB] shadow-lg shadow-[#E5E7EB]/30">
            {userPicture ? (
              <Image
                src={userPicture}
                alt="Profile"
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full flex items-center justify-between bg-zinc-800 hover:bg-zinc-700 rounded px-5 py-3 text-left transition border-l-4 border-[#E5E7EB] hover:border-[#6B7280]">
          ...
          <button
            ...
            className="w-full flex items-center justify-between bg-zinc-800 hover:bg-zinc-700 rounded px-5 py-3 text-left transition border-l-4 border-[#6B7280] hover:border-[#9CA3AF]">
            <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-between bg-zinc-800 hover:bg-zinc-700 rounded px-5 py-3 text-left transition border-l-4 border-[#9CA3AF] hover:border-[#E5E7EB]">
            <div className="flex items-center space-x-2">
