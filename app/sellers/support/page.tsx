    ...
    <div className="p-6">
      <div className="flex items-center mb-6">
        <div>
          ...
          <p className="text-gray-400 mt-1">Get help with any issues or questions you have.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-[#1a1a1a] rounded-lg p-6">
          ...
          <form className="space-y-6">
            ...
            <Button className="bg-purple-600 hover:bg-purple-700 w-full">Submit Ticket</Button>
          </form>
        </div>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-[#333] pb-4">
                <h4 className="font-medium mb-2">How do I add a new product?</h4>
                <p className="text-gray-400 text-sm">
                  You can add a new product by clicking on the "New Listing" option in the sidebar menu, or by clicking
                  the "Add Product" button on the My Listings page.
                </p>
              </div>
              <div className="border-b border-[#333] pb-4">
                <h4 className="font-medium mb-2">How do I process an order?</h4>
                <p className="text-gray-400 text-sm">
                  Orders can be processed from the Sales page. Click on the order you want to process, then update the
                  status as needed.
                </p>
              </div>
              <div className="border-b border-[#333] pb-4">
                <h4 className="font-medium mb-2">When will I receive payment for my sales?</h4>
                <p className="text-gray-400 text-sm">
                  Payments are processed within 3-5 business days after an order is marked as delivered and the customer
                  has confirmed receipt.
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-2">How do I update my store information?</h4>
                <p className="text-gray-400 text-sm">
                  You can update your store information from the Settings page. Click on the Settings option in the
                  sidebar menu to access your store settings.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400">Support hours: 9am - 5pm (Mon-Fri)</span>
              </div>
            </div>
          </div>
        </div>
