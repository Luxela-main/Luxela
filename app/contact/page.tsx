    ...
    <div className="min-h-screen bg-[#0E0E0E] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {/* Contact Info Card 1 */}
          <div className="bg-[#141414] border border-[#2B2B2B] rounded-lg p-6 hover:border-[#3B3B3B] transition-colors">
          ...
          <div className="bg-[#141414] border border-[#2B2B2B] rounded-lg p-6 hover:border-[#3B3B3B] transition-colors">
            ...
            <p className="text-[#DCDCDC] text-sm font-medium">
        ...
        {/* Contact Form */}
        <div className="bg-[#141414] border border-[#2B2B2B] rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                className="bg-[#0E0E0E] border-[#2B2B2B] text-white placeholder:text-[#808080]"
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={6}
                className="bg-[#0E0E0E] border-[#2B2B2B] text-white placeholder:text-[#808080] resize-none"
              />
            ...
            <div className="flex gap-3 pt-4">
              <Button
                ...
                className="flex-1 bg-purple-600 hover:bg-purple-700 text-white disabled:opacity-50 disabled:cursor-not-allowed font-medium"
              >
              ...
              <Button
                ...
                variant="outline"
                className="border-[#2B2B2B] text-[#808080] hover:text-white hover:bg-[#1a1a1a]"
              >
                Clear
              </Button>
            </div>
